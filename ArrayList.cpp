...
// print items stored in each index of the array
template<class ItemType>
void displayList()
{
	for (int x = 1; x < 6 + 1; x++) // array size in this sample starts at index 1 and ends at index 5. if size was undefined, would set condition as < array.getLength()+1
	{
		cout << items[x] << endl;
	}
